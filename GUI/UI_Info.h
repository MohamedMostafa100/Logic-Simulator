...
struct UI_Info	//User Interface Info.
{
	...
	DSGNMODE DesignToolbar;   //The Design toolbar that is displayed (Add Component or the default design mode toolbar)

	static const int	width = 1450, height = 750,	//Window width and height
		wx = 15, wy = 15,			//Window starting coordinates
		StatusBarHeight = 50,	//Status Bar Height
		ToolBarHeight = 110,		//Tool Bar Height (distance from top of window to bottom line of toolbar)
	...
	//**
	color EmptyToolbarColor;     //Empty space in toolbar
	color LinesColor;			 //Color for all lines
	...
	static const int	Inverter_Width = 50,		//Inverter Gate Image default width
		Inverter_Height = 50;		//Inverter Gate Image default height
	static const int	Buffer_Width = 50,		//Buffer Gate Image default width
	...
	static const int	XNOR3_Width = 50,		//XNOR3 Gate Image default width
